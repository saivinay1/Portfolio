      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col space-y-6 sm:flex-row sm:justify-between sm:items-center sm:space-y-0">
          ...
          <div className="flex justify-center space-x-4">
            <a
              href="https://github.com/saivinay1"
              target="_blank"
            ...
            <a
              href="https://www.linkedin.com/in/saivinay-vasamsetti"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-blue-400 transition-colors p-2"
              aria-label="LinkedIn"
            ...
            <a
              href="https://api.whatsapp.com/send?phone=916303113002&text=HI%20vinay"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-blue-400 transition-colors p-2"
              aria-label="WhatsApp"
        ...
        {/* Bottom Section */}
        <div className="mt-6 sm:mt-8 pt-4 sm:pt-8 border-t border-gray-700 text-center">
